<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in userAddressList" :key="item.id" @click="changeAddress(item)">
...
export default {
  ...
  computed: {
    ...mapGetters(['userAddressList', 'trade', 'detailArrayList'])
  },
  methods: {
    changeAddress(i) {
      // console.log(i)
      this.userAddress.userAddress = i.userAddress
      this.userAddress.consignee = i.consignee
      this.userAddress.phoneNum = i.phoneNum
    },
    async submitOrder() {
      const tradeNo = this.trade.tradeNo
      const data = {
      ...
      if (data.consignee === undefined) return alert('请选择收货地址')
